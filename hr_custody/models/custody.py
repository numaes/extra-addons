...
class HrCustody(models.Model):
    ...
    date_request = fields.Date(string='Requested Date', required=True, tracking='always', readonly=True,
                               help="Requested date",
    ...
    purpose = fields.Char(string='Reason', tracking='always', required=True, readonly=True, help="Reason",
                          states={'draft': [('readonly', False)]})
    custody_name = fields.Many2one('custody.property', string='Property', required=True, readonly=True,
                                   help="Property name",
                                   states={'draft': [('readonly', False)]})
    return_date = fields.Date(string='Return Date', required=True, tracking='always', readonly=True,
                              help="Return date",
                              states={'draft': [('readonly', False)]})
    renew_date = fields.Date(string='Renewal Return Date', tracking='always',
