...
class ProductTemplate(models.Model):
    ...
    feed_pzn = fields.Char(
        string='PZN',
        compute='_compute_feed_pzn',
        inverse='_inverse_feed_pzn',
        store=True,
        help='Pharma Central Number',
    )
    ...
    @api.depends('product_variant_ids.feed_pzn')
    def _compute_feed_pzn(self):
        self._compute_template_field_from_variant_field('feed_pzn')

    def _inverse_feed_pzn(self):
        self._set_product_variant_field('feed_pzn')
